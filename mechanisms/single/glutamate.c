...
#define maxModNMDA _p[12]
#define max2NMDA _p[13]
#define maxModAMPA _p[14]
#define max2AMPA _p[15]
#define damod _p[16]
#define l1NMDA _p[17]
#define l2NMDA _p[18]
#define l1AMPA _p[19]
...
#define modulation modulation_glutamate
...
#define ca_ratio_nmda ca_ratio_nmda_glutamate
 double ca_ratio_nmda = 0.1;
#define ca_ratio_ampa ca_ratio_ampa_glutamate
 ...
 "ca_ratio_ampa_glutamate", &ca_ratio_ampa_glutamate,
 "ca_ratio_nmda_glutamate", &ca_ratio_nmda_glutamate,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 44, 5);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 glutamate C:/Users/tomth/SPN_Hons/mechanisms/single/glutamate.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g_nmda = ( B - A ) * modulation ( _threadargscomma_ maxModNMDA , max2NMDA , l1NMDA , l2NMDA ) ;
   block = MgBlock ( _threadargs_ ) ;
   i_nmda = g_nmda * ( v - erev ) * block * nmda_scale_factor ;
   g_ampa = ( D - C ) * modulation ( _threadargscomma_ maxModAMPA , max2AMPA , l1AMPA , l2AMPA ) ;
